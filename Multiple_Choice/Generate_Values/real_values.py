...
def generate_real_values_almost_constant(n: int, error_rate: float, r: int) -> list[float]:
    values = [1.0] * n  # All values are 1
    indices = random.sample(range(n), r)  # Randomly select r different indices to have higher values
